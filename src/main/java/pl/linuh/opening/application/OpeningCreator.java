...
public class OpeningCreator {
    ...
    //list all openings
    @RequestMapping(value = "/v1/{username}/openings")
    public Iterable<Opening> getOpenings(@PathVariable("username") String username) {
        return openingRepository.findAll();
    }

    //create new opening?
    @RequestMapping(value = "/v1/{username}/openings/{openingName}",method = RequestMethod.PUT)
    ...
    @RequestMapping(value = "/v1/{username}/openings/{openingName}")
    ...
    @RequestMapping(value = "/v1/{username}/openings/{openingName}", method = RequestMethod.DELETE)
